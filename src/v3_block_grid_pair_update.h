...
// Rebuilds one pair's manifolds directly into its contact, the way an ordinary Box3D manifold
// function does. A pair that cannot produce geometry, for any reason, ends the step separated with
// no manifolds; no other contact is touched, and nothing is held back for a later publication.
