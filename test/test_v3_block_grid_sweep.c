...
//
// Everything here is measured through the public seam. A sweep publishes three things
// a caller can see: where the fast body ends the step, how fast it is still going, and
// what v3World_GetBlockGridPairCounters counted. Nothing below reads engine internals.
