...
//
// Engine-side adapters for the static BlockGrid shape. Each one narrows the
...
// Mass properties from the logical blocks, not the collision hitboxes. Blocks
// are the material the assembly is made of; hitboxes are its surface, and they
// overlap, protrude, and get merged, so integrating them would double count.
