...
static int RunTunnelScene( float hullSpeed, float maximumLinearSpeed, TunnelObservation* observation )
{
	...
	// This fixture uses discrete contacts and Speculative Contact.
...
// Checks contact admission during finite motion and independently observes speed
// to verify the configured clamp.
...
// Checks storage and retrieval of the candidate cap used during Projectile sweeps.
