...
// Rebuilding resting manifolds leaves a small residual speed. The fixture measured
// 0.0695 m/s at a timestep of 1/60 s with four substeps.
...
// A resting BlockGrid contact preserves its points and solved impulses across steps
// while rebuilding the manifold.
...
// Conveyor tangent velocity from the cooked material table moves the resting body.
// The contact must resolve its material on each step, including while at rest.
